...
const WORDS = [
  "Аяга", "Таваг", "Халбага", "Сэрээ", "Хутга",
  "Сав", "Данх", "Шил", "Лонх", "Таг",
  "Сандал", "Ширээ", "Ор", "Дэр", "Хөнжил",
  "Шүүгээ", "Толь", "Цонх", "Хаалга", "Түлхүүр",
  "Гар утас", "Чихэвч", "Компьютер", "Хулгана", "Гар",
  "Цэнэглэгч", "Кабель", "Дэлгэц", "Товчлуур", "Камер",
  "Ном", "Дэвтэр", "Бал", "Харандаа", "Баллуур",
  "Шугам", "Үзэг", "Цүнх", "Хавтас", "Самбар",
  "Цамц", "Өмд", "Гутал", "Малгай", "Ороолт",
  "Бээлий", "Цүнх", "Бүс", "Цүнхэвч", "Хүрэм",
  "Бөмбөг", "Дугуй", "Машин", "Дугуйн түлхүүр", "Суудал",
  "Тоормос", "Жолоо", "Толь", "Дугуй", "Гэрэл",
  "Саван", "Алчуур", "Сойз", "Оо", "Шампунь",
  "Шүршүүр", "Угаалтуур", "Суултуур", "Толь", "Сэнс",
  "Гэрэл", "Лаамп", "Утас", "Залгуур", "Унтраалга",
  "Хөргөгч", "Пийшин", "Богино долгионы зуух", "Халуун сав", "Хоолны сав",
  "Алим", "Гадил", "Жүрж", "Талх", "Будаа",
  "Мах", "Өндөг", "Сүү", "Бяслаг", "Тараг",
  "Цаас", "Хайч", "Наалт", "Скотч", "Хайрцаг",
  "Автобус", "Автобусны буудал", "Карт уншигч", "Нийтийн тээврийн карт", "Метроны карт",
  "Такси", "Таксины тоолуур", "Жолоочийн суудал", "Суудлын бүс", "Толь",
  "Замын гэрэл", "Замын тэмдэг", "Явган хүний гарц", "Гарцын товчлуур", "Хашлага",
  "Зогсоол", "Төлбөрийн машин", "Дугуйн зогсоол", "Дугуй түгжээ", "Скүүтер",
  "Скүүтерийн цэнэглэгч", "Шатахуун түгээгч", "Шатахууны буу", "Тосны сав", "Агаар шахагч",
  "Авто угаалга", "Угаалгын буу", "Алчуур", "Хөөс", "Тоос сорогч",
  "Дэлгүүрийн сагс", "Тэрэг", "Кассын ширээ", "Кассын машин", "Бар код уншигч",
  "Бар код", "Чек", "Карт уншигч (POS)", "Карт", "Бэлэн мөнгө",
  "Зоос", "Түрийвч", "Картны гэр", "Уут", "Хайрцаг",
  "Лангуу", "Тавиур", "Хөргөгч", "Хөлдөөгч", "Шошго",
  "Ресторан ширээ", "Сандал", "Меню", "Таваг", "Аяга",
  "Сэрээ", "Халбага", "Хутга", "Салфетка", "Тавиур (tray)",
  "Кофены машин", "Кофены аяга", "Соруул", "Таг", "Сахарын сав",
  "Оффисын ширээ", "Оффисын сандал", "Компьютер", "Гар", "Хулгана",
  "Дэлгэц", "Принтер", "Сканнер", "Баримт бичиг", "Файл хавтас",
  "Ширээний гэрэл", "Цэнэглэгч", "Кабель", "USB", "WiFi роутер",
  "Ханын цаг", "Самбар", "Маркер", "Арчигч", "Тэмдэглэлийн цаас",
  "Лифт", "Лифтний товч", "Шат", "Барилгын хаалга", "Кодны самбар",
  "Домофон", "Түлхүүр", "Ключ", "Цоож", "Хаалганы бариул",
  "Цонх", "Хөшиг", "Тагт", "Тагтны хаалга", "Агааржуулагч",
  "Халаагуур", "Радиатор", "Сэнс", "Агаар цэвэршүүлэгч", "Чийгшүүлэгч",
  "Угаалгын машин", "Хатаагч", "Индүү", "Индүүний тавцан", "Хувцас өлгүүр",
  "Гутлын тавиур", "Гутлын уяа", "Шүхэр", "Малгай", "Бээлий",
  "Гудамжны гэрэл", "Камер (CCTV)", "Дохиолол", "Хаалт", "Хашлага",
  "Хогийн сав", "Хогийн уут", "Дахиврын сав", "Шүүр", "Хүрз",
  "Цас цэвэрлэгч", "Мөс хусагч", "Зам цэвэрлэгч машин", "Усны хоолой", "Крант",
  "Гал унтраагуур", "Галын дохиолол", "Авралын шат", "Анхны тусламжийн хайрцаг", "Боолт",
  "Эмийн хайрцаг", "Термометр", "Маск", "Бээлий (эмнэлгийн)", "Санитайзер",
  "АТМ машин", "Мөнгө гаргагч", "Мөнгөний дэвсгэрт", "Квитанц", "Дансны дэвтэр",
  "Банкны карт", "Карт уншигч", "Дэлгэц (ATM)", "Товчлуур (ATM)", "Камер (ATM)",
  "Шуудангийн хайрцаг", "Илгээмж", "Хайрцаг", "Скотч", "Хаягны шошго",
  "Курьерийн цүнх", "Тэрэг (курьер)", "QR код", "Сканнер", "Аппликейшний дүрс",
  "Ухаалаг утас", "Чихэвч", "Повербанк", "Сим карт", "Санах ойн карт",
  "Цэнэглэгч кабель", "Утасны гэр", "Дэлгэц хамгаалагч", "Tripod", "Selfie stick",
  "Спорт заалны карт", "Шкаф", "Шкафны түлхүүр", "Алчуур", "Усны сав",
  "Гүйлтийн зам", "Дамббелл", "Штанг", "Дэвсгэр", "Сэнс (gym)",
  "Тасалбар", "Киноны тасалбар", "Суудлын дугаар", "Попкорн сав", "Ундааны аяга",
  "Номын сангийн карт", "Ном", "Номын тавиур", "Суудал", "Чимээгүй тэмдэг"
];
